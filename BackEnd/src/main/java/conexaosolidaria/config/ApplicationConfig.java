...
public class ApplicationConfig {
    public ApplicationServer createServer(int port) {
        ...
        InstituicaoController instituicaoController = new InstituicaoController(authService, instituicaoService,
                accessControl);
        NutricionistaController nutricionistaController = new NutricionistaController(authService, nutricionistaService,
                accessControl);
        AlimentoController alimentoController = new AlimentoController(authService, alimentoService, accessControl);
