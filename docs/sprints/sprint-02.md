...
|---|---|---|
| `docs/requisitos/requisitos.md` | `[link]` | `Documento que será criado para registrar os requisitos e o escopo da solução.` |
| `---` | `[link]` | `---` |
| `GitHub Project` | `[link]` | `Será utilizado para acompanhar as tarefas da Sprint 2.` |
